...
export default function ImagePage() {
  return <ToolPageShell label="02 — Image" title="Image operations without cloud upload." description="Remove, upscale, filter, convert, and batch process images through local Python routes." toolkit="image" tools={tools} />;
}
